#Author: Kameron Carter Date: 9/16/25 Purpose: Tree based models

#Load the library
library(rpart)

#Growing the tree: prediction where does Age, Number and Start has any relation with kyphosis
fit <- rpart(Kyphosis ~ Age + Number + Start, method="class", data= kyphosis)

#Display results in fit
printcp(fit) 
...
#Pruning the tree result: Performed to avoid the overfitting of data, reduce 
